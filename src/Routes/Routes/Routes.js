...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader:({params}) => fetch(`https://pigeon-haat-server.vercel.app/categories/${params.id}`),
            }
        ]
    },
    {
        ...
        children:[
            ...
            },
            {
                ...
                loader:({params}) => fetch(`https://pigeon-haat-server.vercel.app/dashboard/${params.uid}`)
            },
            {
